...
const InfoIcon = () => (
  <span className="ml-2 text-gray-500 dark:text-gray-400 cursor-pointer">[?]</span>
);
...
const SreErrorBudgetDashboard: React.FC = () => {
  ...
  return (
    <div className="p-4 md:p-8 bg-gray-100 dark:bg-gray-900 min-h-screen font-sans">
      <h1 className="text-4xl font-bold mb-8 text-gray-900 dark:text-gray-100">SRE Error Budget Dashboard</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md">
          <h2 className="text-2xl font-semibold mb-6 text-gray-800 dark:text-gray-200">1. SLO Definition & Budget</h2>
          ...
          <div className="mb-6">
            ...
            <input
              ...
              className="w-full p-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-200 rounded-lg shadow-sm focus:ring-2 focus:ring-indigo-500 transition"
              step="0.001"
              min="0"
              max="100"
            />
          ...
          <div className="mb-6">
            <label className="block text-lg font-medium text-gray-700 dark:text-gray-300 mb-2">Time Window</label>
            <div className="flex space-x-2">
              {[28, 30, 90].map(days => (
                <button
                  key={days}
                  onClick={() => setTimeWindow(days)}
                  className={`flex-1 py-2 px-4 rounded-lg font-semibold transition ${timeWindow === days ? 'bg-indigo-600 text-white shadow-lg' : 'bg-gray-200 text-gray-800 hover:bg-gray-300 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600'}`}>
                  {days} days
                </button>
              ))}
            </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-4 text-center">
              <div className="bg-indigo-50 dark:bg-indigo-900/50 p-4 rounded-lg">
                <p className="text-2xl font-bold text-indigo-800 dark:text-indigo-200">{errorBudget.days.toFixed(2)}</p>
                <p className="text-sm text-indigo-600 dark:text-indigo-400">Days</p>
              </div>
              <div className="bg-purple-50 dark:bg-purple-900/50 p-4 rounded-lg">
                <p className="text-2xl font-bold text-purple-800 dark:text-purple-200">{errorBudget.hours.toFixed(2)}</p>
                <p className="text-sm text-purple-600 dark:text-purple-400">Hours</p>
              </div>
              <div className="bg-pink-50 dark:bg-pink-900/50 p-4 rounded-lg">
                <p className="text-2xl font-bold text-pink-800 dark:text-pink-200">{errorBudget.minutes.toFixed(2)}</p>
                <p className="text-sm text-pink-600 dark:text-pink-400">Minutes</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-1 bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md">
          <h2 className="text-2xl font-semibold mb-6 text-gray-800 dark:text-gray-200">2. Consumption & Burn Rate</h2>

          <div className="mb-6">
            <label className="block text-lg font-medium text-gray-700 dark:text-gray-300 mb-2">Downtime Incurred (minutes)</label>
            <input
              type="number"
              value={downtime}
          ...
          <div className="mb-6">
            <label className="block text-lg font-medium text-gray-700 dark:text-gray-300 mb-2">Time Elapsed in Window (days)</label>
            <input
              type="number"
              value={timeElapsed}
          ...
          <div className="mb-6">
            <label className="block text-lg font-medium text-gray-700 dark:text-gray-300 mb-2">Remaining Budget</label>
            ...
            <p className="text-center mt-2 text-gray-600 dark:text-gray-400">{budgetConsumed.remainingPercentage.toFixed(2)}% remaining ({budgetConsumed.remainingMinutes.toFixed(2)} minutes)</p>
          </div>
          ...
          <div>
            ...
            <div className="bg-gray-100 dark:bg-gray-700/50 p-4 rounded-lg text-center">
              <p className="text-3xl font-bold text-gray-800 dark:text-gray-200">{burnRate.toFixed(2)}x</p>
              <p className="text-sm text-gray-600 dark:text-gray-400">Normal Rate</p>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-1 bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md">
          <h2 className="text-2xl font-semibold mb-6 text-gray-800 dark:text-gray-200">3. Projections & Alerts</h2>
          ...
          <div className="mb-6">
            ...
            <div className="bg-gray-100 dark:bg-gray-700/50 p-4 rounded-lg text-center">
              <p className="text-2xl font-bold text-gray-800 dark:text-gray-200">{timeToExhaustion}</p>
            </div>
          </div>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg">
                <thead className="bg-gray-50 dark:bg-gray-700/50">
                  <tr>
                    <th className="py-2 px-4 border-b dark:border-gray-700 text-left text-sm font-semibold text-gray-600 dark:text-gray-400">Alert Window</th>
                    <th className="py-2 px-4 border-b dark:border-gray-700 text-left text-sm font-semibold text-gray-600 dark:text-gray-400">Downtime Rate</th>
                  </tr>
                </thead>
                <tbody>
